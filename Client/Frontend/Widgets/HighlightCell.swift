...
class HighlightIntroCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        titleLabel.snp_makeConstraints { make in
            let insets = UIEdgeInsets(top: HighlightIntroCellUX.margin, left: HighlightIntroCellUX.margin, bottom: 0, right: 0)
            make.leading.top.equalTo(self.contentView).inset(insets)
        }
        ...
        descriptionLabel.snp_makeConstraints { make in
          ...
          //  make.bottom.equalTo(self.contentView).offset(-HighlightIntroCellUX.margin)
        }
